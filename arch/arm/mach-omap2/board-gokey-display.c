...
static const u8 lms501kf07_cmd_setcyc1[] = {
	0xb4,
	0x01,
};

static const u8 lms501kf07_cmd_setcyc2[] = {
	0xb4,
	0x02,
};
...
static const u8 mdnie_vidwarm_reg[] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xe4, 0x00, 0xF3, 0x00, 0xFF, 0xFF, 0x00, 0x00,
	0xFF, 0x00, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0x00,
	0xFF, 0x00, 0xFF, 0xFF, 0x00, 0x06, 0x20, 0x00, 0x20, 0x00,
	0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
	0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
...
static const u8 mdnie_vidcold_reg[] = {
	...
	0x5A, 0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xFF, 0x00, 0xee, 0x00, 0xe8, 0xFF, 0x00, 0x00,
	0xFF, 0x00, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0x00,
	0xFF, 0x00, 0xFF, 0xFF, 0x00, 0x06, 0x20, 0x00, 0x20, 0x00,
	0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
	0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
...
static const struct lms501kf07_inver_data gokey_inver_data = {
	.one = (u8 *)lms501kf07_cmd_setcyc1,
	.two = (u8 *)lms501kf07_cmd_setcyc2,
	.size = ARRAY_SIZE(lms501kf07_cmd_setcyc1),
};
...
static const struct lms501kf07_sequence_entry gokey_lcd_seq_display_on[] = {
	...
	{
	 .cmd = lms501kf07_cmd_setcyc1,
	 .cmd_len = ARRAY_SIZE(lms501kf07_cmd_setcyc1),
	 .msleep = 0,
	 },
	{
...
static void set_inver_data(struct lms501kf07_sequence_entry *init_seq, u8 *data)
{
	/* dot inversion is on the 7th place in init sequence */
	init_seq[7].cmd = data;
}
...
static struct panel_lms501kf07_data gokey_lcd_data = {
	...
	.inver_data = &gokey_inver_data,
	.set_inver_data = set_inver_data,
	.get_temp = get_temp,
};
