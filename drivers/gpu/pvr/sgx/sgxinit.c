...
#define HW_RECOVERY_MAX_COUNT 6
static unsigned int hw_recovery_count;
...
//	ui32TempClockinus = OSClockus();
	hw_recovery_count++;
	if (HW_RECOVERY_MAX_COUNT < hw_recovery_count) {
	PVR_LOG(
	("Force going to Kernel Panic by HW recover counting(%d) !!!",
	hw_recovery_count));
